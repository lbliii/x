...
substitutions = [
    ".. meta::",
    "   :author: Tara",
    ".. |product| replace:: Determined",
    ".. |conf| replace:: File: conf.py",
    f".. |current| replace:: <version> ",
]
rst_prolog = "\n".join(substitutions)

# Could this be used to reference determined git repo docs?
intersphinx_mapping = {
...
html_baseurl = "https://docs.determined.com"
html_extra_path = ["robots.txt", "_redirects"]
html_context = {
    "mode": "production",
    "feedback_url": "<your feedback url>",
}
...
html_theme_options = {
    ...
    "extra_header_link_icons": {
        "repository on GitHub": {
            "link":  "https://github.com/determined-ai/determined",
            "icon": '<svg height="26px" style="margin-top:-2px;display:inline" '
                'viewBox="0 0 45 44" '
                'fill="currentColor" xmlns="http://www.w3.org/2000/svg">'
                '<path fill-rule="evenodd" clip-rule="evenodd" '
                'd="M22.477.927C10.485.927.76 10.65.76 22.647c0 9.596 6.223 17.736 '
